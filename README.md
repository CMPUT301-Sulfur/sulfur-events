...
```text
app/src/main/java/com/example/sulfurevents/
├── MainActivity.java             # Entry point (Handles Role/Profile Check)
├── EntrantActivity.java          # Main hub for Entrant features
├── OrganizerActivity.java        # Main hub for Organizer features
├── AdminDashboardActivity.java   # Main hub for Admin features
├── BottomNavigationHelper.java   # Utility for handling navigation logic
├── adapters/                     # RecyclerView adapters for lists
├── models/                       # Data models (Event, User, Notification)
└── ...
```
